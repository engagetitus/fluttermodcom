...
Row(
children: [
Flexible(flex: 1,fit:FlexFit.tight, child: Column(
children: [
Container(
color: Colors.black,
height: 10.0,
...
const Flexible(flex : 5,fit:FlexFit.tight, child: Text('Kenya', style: TextStyle(
fontSize: 25.2,
)),)
...
Row(children: [
  ...
  const Expanded(flex: 5, child: Text("I Like Flutter")),
