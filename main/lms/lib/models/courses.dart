...
class Courses {
  ...
  factory Courses.fromMap(Map<String, dynamic> map) {
    return Courses(
      ...
      topics: List<Resources>.from((map['topics'] as List<int>).map<Resources>((x) => Resources.fromMap(x as Map<String,dynamic>),),),
...
Courses(id : 'id', code : 'code', name : 'Data Science', description: 'description', topics: [Resources(url: 'url', isAvailable: true, title: 'title')], createdAt: DateTime.now() ),
Courses(id : 'id', code : 'code', name : 'Data Science', description: 'description', topics: [Resources(url: 'url', isAvailable: true, title: 'title')], createdAt: DateTime.now() ),
Courses(id : 'id', code : 'code', name : 'Data Science', description: 'description', topics: [Resources(url: 'url', isAvailable: true, title: 'title')], createdAt: DateTime.now() ),
Courses(id : 'id', code : 'code', name : 'Data Science', description: 'description', topics: [Resources(url: 'url', isAvailable: true, title: 'title')], createdAt: DateTime.now() ),
];
...
class Resources {
  ...
  factory Resources.fromJson(String source) => Resources.fromMap(json.decode(source) as Map<String, dynamic>);

  @override
  String toString() => 'Resources(url: $url, isAvailable: $isAvailable, title: $title)';
